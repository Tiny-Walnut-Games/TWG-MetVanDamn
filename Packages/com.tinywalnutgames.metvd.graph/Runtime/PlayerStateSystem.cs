...
namespace TinyWalnutGames.MetVD.Graph
{
    ...
    public partial struct UpdateTemporaryAbilityTimersJob : IJobEntity
    {
        ...
        {
            // In a full implementation, this would track individual ability timers
            // and remove expired temporary abilities
            // For now, just maintain the component structure
        }
    }
