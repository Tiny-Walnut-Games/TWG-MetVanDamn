...
namespace TinyWalnutGames.MetVD.QuadRig
    {
    // 🧙‍♂️ SACRED STORY TEST: Complete validation suite ensuring Quad-Rig prototype functionality
    // 🔧 ENHANCEMENT READY: Comprehensive test coverage for all DOTS systems and components
    // 🍑 CHEEK PRESERVATION: Protects against regression by validating all critical paths
    ...
    public class QuadRigStoryTest : MonoBehaviour
        ...
        // Story test state
        private Entity[] characterEntities = System.Array.Empty<Entity>();
        private EntityManager entityManager;
        private World world = null!; // assigned in InitializeECSWorld
        private SystemHandle billboardSystemHandle; // ISystem handle
        ...
        private void InitializeECSWorld()
            ...
            // Get ISystem handle & managed systems
            billboardSystemHandle = world.GetExistingSystem<BillboardSystem>();
        ...
        private void SetupCamera()
            ...
            if (billboardSystemHandle != SystemHandle.Null)
                {
                var bb = world.Unmanaged.GetUnsafeSystemRef<BillboardSystem>(billboardSystemHandle);
                bb.SetCameraPosition(cameraTransform.position);
                }
        ...
        private void TestBillboardFunctionality()
            ...
            if (billboardSystemHandle != SystemHandle.Null)
                {
                var bb = world.Unmanaged.GetUnsafeSystemRef<BillboardSystem>(billboardSystemHandle);
                bb.SetCameraPosition(cameraPos);
                }
