...
namespace TinyWalnutGames.MetVD.Authoring.Tests
{
    ...
    public class SubSceneConversionTests
    {
        ...
        public void SubSceneComponent_CanBeCreated_AndConfigured()
        {
            ...
            var subSceneComponent = subSceneObject.AddComponent<SubScene>();
        ...
        public void SubSceneWorkflow_ValidatesEntityCreation_ForDistrictConversion()
        {
            ...
            try
            {
                ...
                var districtCount = districtQuery.CalculateEntityCount();
                ...
                var districtEntities = districtQuery.ToEntityArray(Unity.Collections.Allocator.Temp);
        ...
        public void SubSceneConversionWorkflow_ValidatesCompleteLogic_WithoutFileSystem()
        {
            ...
            try
            {
                ...
                foreach (var (name, canConvert) in conversionResults)
                {
        ...
        {
            var field = typeof(SmokeTestSceneSetup).GetField(fieldName,
        ...
        {
            var method = typeof(SmokeTestSceneSetup).GetMethod(methodName,
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
