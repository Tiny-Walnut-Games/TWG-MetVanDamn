...
namespace TinyWalnutGames.MetVanDAMN.Authoring.Editor
	...
	public static class CreateSampleSceneMenu
		...
		public static void CreateSampleScene()
			...
			EcsPrefabRegistryAuthoring reg = go.AddComponent<EcsPrefabRegistryAuthoring>();
			...
			string path = "Assets/Scenes/MetVanDAMN_Baseline.unity";
			System.IO.Directory.CreateDirectory("Assets/Scenes");
			UnityEditor.SceneManagement.EditorSceneManager.SaveScene(scene, path);
			AssetDatabase.Refresh();
			EditorUtility.DisplayDialog("MetVanDAMN",
				"Sample scene created at Assets/Scenes/MetVanDAMN_Baseline.unity. Assign prefabs to the ECS Prefab Registry entries.",
				"OK");
			}
		}
	}
