...
namespace TinyWalnutGames.MetVanDAMN.Authoring.Editor
    ...
    public static class MapGenerationMenu
        {
        [MenuItem("Tools/MetVanDAMN/Map Generation/🗺️ Generate World Map", priority = 50)]
        public static void GenerateWorldMap()
            ...
            if (mapGenerator)
                ...
                {
                Debug.LogWarning("⚠️ No MetVanDAMNMapGenerator found in scene. Please create a demo scene first using 'Tools/MetVanDAMN/Create Base DEMO Scene'");
                }
            }

        [MenuItem("Tools/MetVanDAMN/Map Generation/🧭 Toggle Minimap", priority = 51)]
        ...
        [MenuItem("Tools/MetVanDAMN/Map Generation/🖼️ Toggle Detailed Map", priority = 52)]
        ...
        [MenuItem("Tools/MetVanDAMN/Map Generation/📁 Export Map as Image", priority = 53)]
        ...
        [MenuItem("Tools/MetVanDAMN/Map Generation/🔄 Regenerate All Maps", priority = 54)]
        ...
        [MenuItem("Tools/MetVanDAMN/Map Generation/🗺️ Generate World Map", true)]
        ...
        [MenuItem("Tools/MetVanDAMN/Map Generation/🧭 Toggle Minimap", true)]
        public static bool ValidateToggleMinimap()
            {
            return Application.isPlaying && Object.FindFirstObjectByType<MetVanDAMNMapGenerator>() != null;
            }

        [MenuItem("Tools/MetVanDAMN/Map Generation/🖼️ Toggle Detailed Map", true)]
        public static bool ValidateToggleDetailedMap()
            {
            return Application.isPlaying && Object.FindFirstObjectByType<MetVanDAMNMapGenerator>() != null;
            }

        [MenuItem("Tools/MetVanDAMN/Map Generation/📁 Export Map as Image", true)]
        public static bool ValidateExportMapAsImage()
            {
            return Application.isPlaying && Object.FindFirstObjectByType<MetVanDAMNMapGenerator>() != null;
            }

        [MenuItem("Tools/MetVanDAMN/Map Generation/🔄 Regenerate All Maps", true)]
