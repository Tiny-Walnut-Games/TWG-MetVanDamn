...
namespace TinyWalnutGames.MetVanDAMN.Authoring.Editor
    ...
    public class MetVanDAMNMapGeneratorEditor : UnityEditor.Editor
        ...
        public override void OnInspectorGUI()
            ...
            EditorGUILayout.HelpBox("MetVanDAMN Map Generator – Deterministic. Null-free. Battle-tested.", MessageType.Info);
        ...
        private void DrawGenerationControls()
            ...
            using (new EditorGUILayout.VerticalScope(GUI.skin.box))
                ...
                if (GUILayout.Button(_generator.DetailedMapReady ? "Regenerate World Map" : "Generate World Map", GUILayout.Height(28)))
                    {
        ...
        private void DrawStatusSection()
            ...
            using (new EditorGUILayout.VerticalScope(GUI.skin.box))
                ...
                EditorGUILayout.BeginHorizontal();
                DrawBadge(_generator.DetailedMapReady ? "Detailed Map Ready" : "Detailed Map Pending", _generator.DetailedMapReady ? new Color(0.2f, 0.6f, 0.2f) : new Color(0.5f, 0.5f, 0.2f));
                DrawBadge(_generator.MinimapReady ? "Minimap Ready" : "Minimap Pending", _generator.MinimapReady ? new Color(0.2f, 0.6f, 0.2f) : new Color(0.5f, 0.5f, 0.2f));
                EditorGUILayout.EndHorizontal();
                EditorGUILayout.Space(4f);
