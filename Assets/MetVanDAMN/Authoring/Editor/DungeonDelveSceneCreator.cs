...
namespace TinyWalnutGames.MetVanDAMN.Authoring.Editor
	...
	public static class DungeonDelveSceneCreator
		...
		[MenuItem("Tiny Walnut Games/MetVanDAMN!/Create Dungeon Delve Demo Scene")]
	...
	public class DungeonValidationHelper : MonoBehaviour
		{
		[Header("Validation Controls")] [SerializeField]
		private bool runValidationOnStart = true;
		...
		private void Start()
			{
			validator = FindFirstObjectByType<DungeonDelveValidator>();
