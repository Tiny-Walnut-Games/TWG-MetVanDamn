...
namespace TinyWalnutGames.MetVanDAMN.Authoring
{
    ...
    public class DemoLootManager : MonoBehaviour
    {
        ...
        // Loot management
        private List<DemoTreasureChest> activeTreasureChests = new List<DemoTreasureChest>();
        private Dictionary<ItemRarity, float> rarityChances;
        ...
        private LootTable CreateEnemyLootTable()
        {
            return new LootTable
            {
                ...
                items = new LootItem[]
                {
                    new LootItem { item = CreateHealthPotion(), weight = 40 },
                    new LootItem { item = CreateCoin(), weight = 30 },
                    new LootItem { item = CreateIronSword(), weight = 15 },
                    new LootItem { item = CreateLeatherArmor(), weight = 10 },
                    new LootItem { item = CreateMagicRing(), weight = 5 }
                }
            };
        }
        ...
        private LootTable CreateBossLootTable()
        {
            return new LootTable
            {
                ...
                items = new LootItem[]
                {
                    new LootItem { item = CreateMegaHealthPotion(), weight = 25 },
                    new LootItem { item = CreateGoldCoin(), weight = 20 },
                    new LootItem { item = CreateMasterSword(), weight = 20 },
                    new LootItem { item = CreateDragonArmor(), weight = 15 },
                    new LootItem { item = CreateLegendaryRing(), weight = 10 },
                    new LootItem { item = CreateArtifactWeapon(), weight = 10 }
                }
            };
        }
        ...
        private LootTable CreateTreasureLootTable()
        {
            return new LootTable
            {
                ...
                items = new LootItem[]
                {
                    new LootItem { item = CreateGoldCoin(), weight = 35 },
                    new LootItem { item = CreateHealthPotion(), weight = 25 },
                    new LootItem { item = CreateSteelSword(), weight = 15 },
                    new LootItem { item = CreateChainArmor(), weight = 12 },
                    new LootItem { item = CreateEnchantedRing(), weight = 8 },
                    new LootItem { item = CreateRareGem(), weight = 5 }
                }
            };
        }
