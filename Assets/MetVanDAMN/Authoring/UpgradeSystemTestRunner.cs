...
namespace TinyWalnutGames.MetVanDAMN.Authoring
{
    ...
    public class UpgradeSystemTestRunner : MonoBehaviour
    {
        ...
        private bool TestDatabaseManager()
        {
            try
            {
                var dbManager = FindObjectOfType<UpgradeDatabaseManager>();
                if (dbManager == null)
                {
        ...
        private bool TestPlayerProgression()
        {
            try
            {
                var progression = FindObjectOfType<PlayerLevelProgression>();
                if (progression == null)
                {
                    if (enableDetailedLogging)
        ...
        private bool TestChoiceSystem()
        {
            try
            {
                var choiceSystem = FindObjectOfType<LevelUpChoiceSystem>();
        ...
        private bool TestEffectApplication()
        {
            try
            {
                var effectApplicator = FindObjectOfType<UpgradeEffectApplicator>();
        ...
        private bool TestUIIntegration()
        {
            try
            {
                var choiceUI = FindObjectOfType<LevelUpChoiceUI>();
                if (choiceUI == null)
                {
                    if (enableDetailedLogging)
        ...
        public void TestRuntimeUpgradeCreation()
        {
            ...
            try
            {
                ...
                Debug.Log($"Upgrade creation test: {(upgradeCreated ? "PASSED" : "FAILED")}");
