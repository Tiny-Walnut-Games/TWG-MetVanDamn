...
namespace TinyWalnutGames.MetVanDAMN.Authoring
    ...
    public class DungeonDelveMainMenu : MonoBehaviour
        ...
        [SerializeField] private Canvas? mainMenuCanvas = null;
        ...
        [SerializeField] private GameObject? configurationPanel = null;
        ...
        [Header("HUD Elements")]
        [SerializeField] private GameObject? dungeonHUD = null;
        ...
        [SerializeField] private GameObject? completionPanel = null;
        ...
        private void CreateMainMenuElements()
            ...
            if (mainMenuCanvas == null)
                {
                Debug.LogWarning("DungeonDelveMainMenu: mainMenuCanvas unexpectedly null while creating seed display; creating fallback canvas.");
                var fallback = new GameObject("FallbackCanvas").AddComponent<Canvas>();
        ...
        private void ExitToMainMenu()
            ...
            var sceneManager = FindFirstObjectByType<DungeonDelveSceneManager>();
        ...
        private void OnDestroy()
            ...
            if (currentDungeonMode)
                {
                var mode = currentDungeonMode;
                if (mode != null)
                    {
                    // Individual event fields may remain null if the mode never invoked subscription paths
                    mode.OnFloorChanged -= OnFloorChanged;
                    mode.OnBossDefeated -= OnBossDefeated;
                    mode.OnSecretFound -= OnSecretFound;
                    mode.OnProgressionLockObtained -= OnProgressionLockObtained;
                    mode.OnDungeonCompleted -= OnDungeonCompleted;
