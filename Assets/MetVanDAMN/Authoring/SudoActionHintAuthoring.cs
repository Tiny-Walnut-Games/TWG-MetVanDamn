...
namespace TinyWalnutGames.MetVanDAMN.Authoring
    ...
    public class SudoActionHintAuthoring : MonoBehaviour
        {
        [Header("Sudo Action")]
        public string actionKey = "SpecialEvent";
        public bool oneOff = true;
        public float radius = 10f;
        public uint seed = 0;

        [Header("Constraints (optional)")]
        public BiomeElevation elevationMask = BiomeElevation.Any;
        ...
        class Baker : Baker<SudoActionHintAuthoring>
            ...
            public override void Bake(SudoActionHintAuthoring authoring)
                ...
                AddComponent(entity, new SudoActionHint
                    ...
                    HasTypeConstraint = (byte)(authoring.constrainBiomeType && authoring.biomeType != BiomeType.Unknown ? 1 : 0),
                    Seed = authoring.seed,
                    });
                }
            }
