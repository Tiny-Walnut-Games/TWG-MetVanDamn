...
namespace TinyWalnutGames.MetVanDAMN.Authoring
    ...
    public class UpgradeEffectApplicator : MonoBehaviour
        ...
        [Header("Modifiers")]
        [SerializeField] private List<StatModifier> activeModifiers = new();
        ...
        public void ApplyUpgrade(UpgradeDefinition upgrade)
            ...
            if (UpgradeCollection.IsSentinel(upgrade))
                ...
                if (enableDebugLogging)
                    {
                    Debug.Log("⚪ Sentinel upgrade received – no-op applied (deterministic non-null invariant maintained).");
                    }
                return;
                }
        ...
        private void DumpActiveModifiers()
            ...
            for (int i = 0; i < activeModifiers.Count; i++)
                ...
                Debug.Log($" #{i + 1}: upgradeId={m.upgradeId}, stat={m.statName}, type={m.modifierType}, value={m.value}, active={m.isActive}");
                }
            }
