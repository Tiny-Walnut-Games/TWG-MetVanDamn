...
namespace TinyWalnutGames.MetVD.Authoring
	...
	public class BiomeFieldAuthoring : MonoBehaviour
		{
		[Header("Biome Configuration")] public BiomeType biomeType = BiomeType.SolarPlains;

		public BiomeType primaryBiome = BiomeType.SolarPlains;
		public BiomeType secondaryBiome = BiomeType.Unknown;

		[Header("Field Properties")] [Range(0f, 1f)]
		...
		[Header("Node Configuration")] public uint nodeId = 0;
