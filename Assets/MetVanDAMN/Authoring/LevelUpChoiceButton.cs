...
#nullable enable
	...
	public class LevelUpChoiceButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
		...
		private Color normalColor = new(0.2f, 0.2f, 0.2f, 0.9f);
		...
		private void CreateNameAndCategory(Transform parent)
			...
			VerticalLayoutGroup nameLayout = nameContainerObj.AddComponent<VerticalLayoutGroup>();
			...
			HorizontalLayoutGroup categoryLayout = categoryContainerObj.AddComponent<HorizontalLayoutGroup>();
			...
			RectTransform categoryIconRect = categoryIconObj.AddComponent<RectTransform>();
			categoryIconRect.sizeDelta = new Vector2(16f, 16f);

			categoryIcon = categoryIconObj.AddComponent<Image>();

			LayoutElement categoryIconLayout = categoryIconObj.AddComponent<LayoutElement>();
		...
		private void CreatePreview()
			...
			LayoutElement layoutElement = previewObj.AddComponent<LayoutElement>();
		...
		private void SetCategoryVisuals()
			...
			string categoryIconSymbol = GetCategoryIcon();
			...
			if (categoryIcon != null)
				...
				Texture2D iconTexture = CreateCategoryIconTexture(categoryIconSymbol, categoryColor);
				var iconSprite = Sprite.Create(iconTexture, new Rect(0, 0, iconTexture.width, iconTexture.height),
