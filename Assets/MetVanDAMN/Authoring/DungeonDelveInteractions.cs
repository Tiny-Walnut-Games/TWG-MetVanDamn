...
namespace TinyWalnutGames.MetVanDAMN.Authoring
    ...
    public class DungeonProgressionLock : MonoBehaviour
        ...
        private void EnsureBaseline()
            ...
            var rt = _interactionPromptText.GetComponent<RectTransform>();
        ...
        private void ResolvePlayer()
            ...
            var pm = FindFirstObjectByType<DemoPlayerMovement>();
            if (pm)
                {
    ...
    public class DungeonSecret : MonoBehaviour
        ...
        private void ApplySecretRewards()
            ...
            var playerCombat = FindFirstObjectByType<DemoPlayerCombat>();
